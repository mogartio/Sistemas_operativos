...
#else
	// Touch all you want.
	ENV_CREATE(user_testgetprioridad, ENV_TYPE_USER);
	ENV_CREATE(user_cambiarprioridad, ENV_TYPE_USER);
	ENV_CREATE(user_evilcambiarprioridad, ENV_TYPE_USER);
	ENV_CREATE(user_fork, ENV_TYPE_USER);
